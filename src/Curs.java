...
public class Curs {
	...
	public void ModificaStudent(Student student, Student studentnou) {
		...
		// Sterg nota studentului vechi si adaug aceeasi nota pentru studentul nou
		// introdus
	...
	public float MediaStudenti() {
		...
		/*
		 * Varianta in care scrieti voi parcurgerea int media = 0; for (Student s:
		 * studenti) { media += nota.get(s); } return media / (float)studenti.size();
		 */
	}
