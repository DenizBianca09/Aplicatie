...
public class ManagerCursuri {
	// Organizarea claselor se face deobicei dupa regula: Membri, Metode private,
	// Constructori, metode publice
	List<Curs> cursuri;

	// Metoda cauta un curs in lista de cursuri si arunca exceptie in cazul in care
	// nu-l gaseste. Exceptia trebuie tratata in exterior
